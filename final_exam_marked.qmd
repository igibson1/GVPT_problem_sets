...
::: {.callout-tip}
How do we interpret binary variables? 
:::
...
::: {.callout-tip}
You need to talk in terms of the specific variable units. 
:::
...
::: {.callout-tip}
It's not statistically significant at this threshold. 
:::

-   Yes, countries that spend more money on education appear to have a higher literacy rate.

::: {.callout-tip}
It's not statistically significant at this threshold. Therefore, we cannot determine that this effect is any different from chance. 
:::
...
::: {.callout-tip}
Please translate these to the variable's units. 
:::
...
::: {.callout-tip}
Translate these to the variable's units. 
:::
