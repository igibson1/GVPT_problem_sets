...
::: {.callout-tip}
You need to use the t-statistic, not z score, for means. 
:::
...
::: {.callout-tip}
You need to remove the intersection ({5, 5}) to avoid double counting it. 
:::
...
::: {.callout-tip}
You needed to interpret the results. Do the data support my hypothesis? Be sure to explain the nature of the relationship (or lack thereof, if relevant).
:::
...
::: {.callout-tip}
The question asked you to look at only those who were eligible to vote. You needed to filter out the ineligible people. 
:::
...
::: {.callout-tip}
Your standard error of the difference is incorrect. As is your t-statistic. 
:::
...
::: {.callout-tip}
This is a difference between two proportions question, not a difference of counts. You needed to calculate the z score and work out the probability of finding that z score if the null were true. 
:::
