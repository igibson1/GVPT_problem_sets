...
::: {.callout-tip}
A small p-value is good! It means that I am highly unlikely to have found a mean of 610 if, in fact, the null of a mean of 600 were the population's true mean. Therefore, I can reject the null hypothesis with `r scales::percent(1 - p_value, accuracy = 0.01)` confidence.
:::
...
::: {.callout-tip}
Because the null hypothesis of 50 falls within your 95% CI, you cannot reject the null hypothesis with this level of confidence. Just as you say below. This CI *does not* support the hypothesis that feelings toward President Biden are greater than 50.
:::
...
::: {.callout-tip}
This is a difference of means test, not a difference of proportions test. We are working with samples, so we need to use the t-statistic, not the z-score. 
:::
