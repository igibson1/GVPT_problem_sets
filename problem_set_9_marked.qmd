...
library(plotly)
censusAggregate <- read_csv("censusAggregate.csv")
# View(censusAggregate)
```

::: {.callout-tip}
Please don't hard code your filepaths into your scripts. It creates errors.
:::

::: {.callout-tip}
Also, please check your rendered output before submitting. This included an unweildy `View()`. 
:::
...
-   The regression results show that being from a Non-southern state is associated with a 5.546 in the voter turnout rate, and statistically significant at the 0.01 level. 

::: {.callout-tip}
Non-Southern states have, on average and holding all else constant, a turnout rate that is 5.546 percentage points higher than Southern states.  
:::

Election day registration is associated with an increase of 5.792 in the turnout rate and is statistically significant at the .01 level. 

::: {.callout-tip}
Compared with a state that does not allow for election-day registration. 

... on average and holding all else constant. 
:::

The percentage of the population that graduated HS is associated with a 0.101 increase in the turnout rate and is statistically significant at the .01 level.
...
::: {.callout-tip}
To answer this question, you need to fit the null model. You can then compare this model to your fuller model to see whether there is a statistically significant difference in their predictive power. 
:::
...
:::{.callout-tip}
Your hypothesis needs to state what you think the relationship between your outcome of interest and the variables you think drive that outcome will be. 
